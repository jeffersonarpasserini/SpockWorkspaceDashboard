    ...
    <html lang="en">
      <body>
        <header className="app-header">
          ...
          <nav aria-label="Primary navigation"><Link href="/">Projects</Link><Link href="/agents">Agents</Link><a href="https://hermes-agent.nousresearch.com/docs/user-guide/features/kanban" target="_blank" rel="noreferrer">Hermes docs</a></nav>
